...
if menu == "Home":
    ...
    with col1:
        st.image("foto beric.jpg", width=300, caption="Bagus Eric Kurniawan")
    with col2:
        st.image("foto mbintang.jpg", width=300, caption="Muchamad Ilham Bintang")
    with col3:
        st.image("foto mrafi.jpg", width=300, caption="Muhammad Rafi Fauzan")
