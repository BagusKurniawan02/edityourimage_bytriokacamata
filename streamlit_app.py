...
if menu == "Home":
    ...
    with col1:
        st.image("https://imgur.com/a/7N7mceZ", caption="Bagus Eric Kurniawan")
    with col2:
        st.image("https://imgur.com/a/X7f2NLe", caption="Muchamad Ilham Bintang")
    with col3:
        st.image("https://imgur.com/a/cbTryKX", caption="Muhammad Rafi Fauzan")
